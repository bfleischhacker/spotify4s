...
/**
  ...
  **/
case class UserPrivate(displayName: Option[String], externalUrls: ExternalUrl, followers: Followers, href: String, id: SpotifyUserId, images: List[Image], `type`: String, uri: SpotifyUri, birthday: String, country: String, email: String, product: UserPrivate.Product)

object UserPrivate {

  sealed abstract class Product(val identifier: String)
