...
object UserPublic {
  implicit val decoder: Decoder[UserPublic] = (Decoder.instance(_.get[Option[String]]("display_name")) |@| Decoder
    ...
    .instance(_.get[String]("type")) |@| Decoder.instance(_.get[String]("uri"))).map(UserPublic.apply)
