...
/**
  ...
  **/
case class Track(artists: List[ArtistSimple], availableMarkets: List[String], discNumber: Int, durationMs: Int, explicit: Boolean, externalUrls: ExternalUrl, href: String, id: SpotifyId, isPlayable: Boolean, linkedFrom: TrackLink, name: String, previewUrl: String, trackNumber: Int, `type`: String, uri: SpotifyUri, album: AlbumSimple, externalIds: ExternalId, popularity: Int)
